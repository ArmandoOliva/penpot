...
use skia_safe::gpu::{self, gl::TextureInfo, gl::FramebufferInfo, DirectContext};
...
impl GpuState {
    ...
    pub fn create_surface_with_dimensions(&mut self, label: String, width: i32, height: i32) -> skia::Surface {
